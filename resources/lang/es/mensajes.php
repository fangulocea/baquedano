...
return [
		...
		'arrendatario' => '{0}Descartado|{1}Sin Gestión(Activo)|{2}Activo|{3}En Espera|{4}Activo - Problema Pago|{5}Activo - Daño inmueble|{6}Contrato Borrador|{7}No Activo - Daño inmueble|{10}Contrato Proceso Firma|{11}Contrato Firmado|{12}No Activo - Problema Pago|{13} Finalizado propietario',
		...
		'contratofinal' => '{1}Proceso de Firma|{2}Contrato Activo|{3}Contrato Vencido|{4}Anexo Contrato|{5}Menor 60 días para vencer|{6}Cerrado por Propietario',
