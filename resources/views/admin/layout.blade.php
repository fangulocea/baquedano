                        ...
                        <li> <a href="#" class="waves-effect"><i class="mdi mdi-settings fa-fw" data-icon="v"></i> <span class="hide-menu"> Administración <span class="fa arrow"></span> <span class="label label-rouded label-primary pull-right">5</span></span></a>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li> <a href="{{ route('contratorenovacionpropietario.index') }}"><i class=" fa-fw">RP</i><span class="hide-menu">Renovación Propietario</span></a> </li>
                                    @endcan
                                </ul>
                            </li>
                            ...
                            <ul class="nav nav-second-level">
                             <li>
                                ...
                                <ul class="nav nav-third-level">
                                 ...
                                 @can('checklist.index')
                                <li> <a href="{{ route('checklist.creachkportipo','todo' ) }}"><i class=" fa-fw">CH</i><span class="hide-menu">eckList Inmueble</span></a> </li>
                                @endcan
