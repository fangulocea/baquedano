...
for(var i=0;i<contratos.length;i++){
                ...
                $.get("/contratofinalarr/consultapagosmensuales/"+contratos[i].id_contrato+"/"+contratos[i].id_inmueble,function(response,state){
                                    ...
                                    for (var r = 0; r < response.length; r++) {
                                     ...
                                     // CONTENIDO
                                         ...
                                         if(response.length>0)
                                         {
                                                ...
                                                if(response[r].moneda=='UF'){
                                                    subtotal=response[r].pago_a_rentas_moneda * $("#uf").val();
                                                }else{
                                                   subtotal= response[r].pago_a_rentas_moneda *1;
                                                }

 
                                                            var cell = document.createElement("td");
                                                            var cellText = document.createTextNode('$ ' + subtotal);
                                                            cell.appendChild(cellText);
                                                            cell.style.border="1px solid black";
                                                            cell.style.padding="8px"
                                                            cell.style.textAlign="center"
