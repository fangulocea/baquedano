...
<form action="{{ route('propietario.checkin_grabar',$contratos->id_contrato) }}" method="post" enctype='multipart/form-data'>
    {!! csrf_field() !!}
    ...
    <div class="form-actions">
             <center>   <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Guardar</button> 
                ...
                <a href="{{ route('propietario.finalizar', $checklist->id) }}" class="btn btn-primary" style="color:white"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Finalizar CheckIn</a>
             </center>
    </div>
    </form>
<hr>
