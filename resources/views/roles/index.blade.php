...
<div class="col-sm-12">
    <div class="white-box">
        <h3 class="box-title m-b-0">Administración de Roles</h3>
        <p class="text-muted m-b-30">Gestionar Roles del sistema</p>
                ...
                <tbody>
                    @foreach($roles as $role)
                            <tr>
                                ...
                                @can('roles.edit')
                                <td width="10px">
                                    <a href="{{ route('roles.edit', $role->id) }}"><span class="btn btn-warning btn-circle btn-lg"><i class="ti-pencil-alt"></i></span></a>
                                </td>
                                @endcan
                                @can('roles.destroy')
                                <td width="10px">
