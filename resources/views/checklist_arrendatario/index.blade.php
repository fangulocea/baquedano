...
<div id="tabla" >
    <div class="white-box">
        <h3 class="box-title m-b-0">Gestión de CheckList aRRENDATARIO</h3>
                    ...
                    @foreach($publica as $p)
                        ...
                        @endphp
                            <tr>
                                ...
                                <td width="10px">
                                    <a href="{{ route('checklist.create_arrendatario', $p->id_contrato)}}" class="btn btn-info" style="color:white"><i class="ti-pencil-alt"></i>&nbsp;&nbsp;Check-In</a>
                                </td>
                            </tr>
                        @php
