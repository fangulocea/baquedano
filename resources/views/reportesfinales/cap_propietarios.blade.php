...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading"> REPORTE CAPTACIONES PROPIETARIOS</div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                 <form action="{{ route('repfinal.genera_captacion_pro') }}" id="form" method="post" enctype='multipart/form-data'>
                    {!! csrf_field() !!} 
                        <div id="tabla" >
                            <div class="white-box">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <button id="boton" type="submit" class="btn btn-block btn-primary btn-rounded">Exportar Reporte</button>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                     </div>
