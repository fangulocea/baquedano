                            ...
                            <form id="form1_a" action="{{ route('finalContratoArr.asignarNotaria',$p->id) }}" method="post">                 
                                ...
                                <td>
                                   @if(ContratoFinalArrController::ValidaCh($p->id) == 0)
                                    ...
                                    <a class="mytooltip" href="{{ route('checklist.checkindexarr',[$p->id,0 , 'Arrendatario',$origen]) }}"> <button  class="btn btn-info btn-circle btn-lg"> <a class="mytooltip"href="{{ route('checklist.checkindexarr',[$p->id,0 , 'Arrendatario',$origen]) }}" style="color:white"><i class="fa fa-check"></i> <span class="tooltip-content3" style="font-size: medium;color:white">Realizar <br> Check-In</span></a></button></a>
