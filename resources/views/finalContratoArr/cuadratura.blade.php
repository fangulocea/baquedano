                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="{{ route('finalContratoArr.savecuadratura',[ $id_contrato, $id_publicacion ]) }}" method="post">
                                        {!! csrf_field() !!}
                                ...
                                <table id="listusers1_c" class="display compact" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>$ {{ $p->valor }}</td>
                                            <td>{{ $p->id_estado }}</td>
                                            <td><a href="{{ route('finalContratoArr.eliminarCuadratura',[$p->id, $id_contrato, $id_publicacion]) }}"><span class="ti-trash"></span></span></a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
