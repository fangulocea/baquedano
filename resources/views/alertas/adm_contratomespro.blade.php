 ...
 paging: false,
    ...
    "ordering": false,
      ...
      "ajax": {
       ...
       "url": "{{ route('alertas.adm_contratomespro_ajax') }}"
          ...
          "columns": [
                ...
                {data: 'fechaanterior', name: 'fechaanterior'},
                 {data: 'valoranterior1', name: 'valoranterior1'},
                 {data: 'fechaactual', name: 'fechaactual'},
                 {data: 'valoractual', name: 'valoractual'},
                 {data: 'fechasiguiente', name: 'fechasiguiente'},
                 {data: 'valorsiguiente1', name: 'valorsiguiente1'},
