...
<form action="{{ route('checklist.savefotos_propietario',$contratos->id_contrato) }}" method="post" enctype='multipart/form-data'>
    {!! csrf_field() !!}
    ...
    <div class="form-actions">
             <center>   <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Guardar</button> 
                <a href="{{ route('checklist.index_propietario') }}" class="btn btn-info" style="color:white"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Volver</a>
                <a href="{{ route('checklist.finalizar_propietario', $checklist->id) }}" class="btn btn-primary" style="color:white"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Finalizar CheckIn</a>
             </center>
    </div>
    </form>
<hr>
