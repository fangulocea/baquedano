                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" value="{{ $comision->nombre }}" class="form-control" placeholder="" required="required" > <span class="help-block"> Identificación de la Comisión </span> </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10 ">
                                        <div class="form-group">
                                            ...
                                            <textarea name="descripcion" id="descripcion" cols="50" rows="10" class="form-control" required="required">{{ $comision->descripcion }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group"> 
                                                    ...
                                                    <input name='comision' value="{{ $comision->comision }}" type="number" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Estado</label>
                                                {{ Form::select('estado',['0'=>'No Vigente','1'=>'Vigente'], $comision->estado ,array('class'=>'form-control','style'=>'','id'=>'regiones','placeholder'=>'Selecciona estado','required'=>'required')) }}
                                            </div>
                                        </div>
                                    </div>
