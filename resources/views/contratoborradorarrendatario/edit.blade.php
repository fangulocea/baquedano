...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <form action="{{ route('cbararrendatario.garantia',[$publica->id_cap_arr]) }}" method="post">
            {!! csrf_field() !!}
            ...
            <tbody>
                @foreach($garantias as $p)
                    <tr>
                        ...
                        <td>$ {{ $p->valor }}</td>
                        <td>{{ $p->fecha_cobro }}</td>
                        <td><a href="{{ route('cbararrendatario.eliminarGarantia',[$p->id, $publica->id_cap_arr]) }}"><span class="ti-trash"></span></span></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('cbararrendatario.updatepersona') }}" method="post" id="form_persona" >
                                            ...
                                            <input type="hidden" name="id_publicacion" value="{{ $id_publicacion->id }}">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="panel panel-info">
                                                        <div class="panel-wrapper collapse in" aria-expanded="true">
