...
<div id="tabla" class="col-sm-12">
    <div class="white-box">
        <h3 class="box-title m-b-0">Administración de Proveedores</h3>
        <p class="text-muted m-b-30">Gestionar Proveedores</p>
    ...
    buttons: [
        'excel',{
            ...
            action: function ( e, dt, node, config ) {
                 window.location.href = '{{ route("proveedor.create") }}';
            }
        }
