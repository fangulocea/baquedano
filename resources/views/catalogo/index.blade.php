...
<div id="tabla" class="col-sm-12">
    <div class="white-box">
        <h3 class="box-title m-b-0">Administración de Catalogo de Servicios</h3>
                ...
                <tbody>
                    @foreach($servicio as $s)
                            <tr>
                                ...
                                <td>{{ $s->detalle }}</td>
                                <td>{{ $s->moneda }}</td>
                                <td>{{ $s->valor_moneda }}</td>
                                <td>{{ $s->fecha_moneda }}</td>
                                <td>{{ $s->valor_en_moneda }}</td>
    ...
    buttons: [
         'excel',{
            ...
            action: function ( e, dt, node, config ) {
                 window.location.href = '{{ route("catalogo.create") }}';
            }
        }
