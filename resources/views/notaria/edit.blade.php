...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading"> Actualizar Notaría</div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                    <form action="{{ route('notarias.update',$_notaria->id) }}" method="post">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="razonsocial" class="form-control" placeholder="" value="{{ $_notaria->razonsocial }}"> <span class="help-block"> Nombre de la notaría </span> </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <input name='direccion' type="text" class="form-control" value="{{ $_notaria->direccion }}"> </div>
                                </div>
                            </div>
                            ...
                            <div class="row"> 
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Región</label>
                                        {{ Form::select('id_region',$regiones, $_notaria->id_region,array('class'=>'form-control','style'=>'','id'=>'regiones','placeholder'=>'Seleccione región','required'=>'required')) }}
                                     </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name='nombreNotario' class="form-control" required="required" value="{{ $_notaria->nombreNotario }}"> </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">Teléfono</label>
                                        <input type="text" name="telefono" class="form-control" required="required" value="{{ $_notaria->telefono }}"> </div>
                                </div>                                                                       <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label">EMail</label>
                                        <input type="email" name="email" class="form-control" required="required" value="{{ $_notaria->email }}"> </div>
                                </div>
                                <!--/span-->
                            </div>
                            ...
                            <div class="row"> 
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Estado</label>
                                        {{ Form::select('estado',['0'=>'No Vigente','1'=>'Vigente'], $_notaria->estado ,array('class'=>'form-control','style'=>'','id'=>'regiones','placeholder'=>'Selecciona estado','required'=>'required')) }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('notarias.index') }}" class="btn btn-info" style="color:white"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Calcelar</a>
                        </div>
                    </form>
                </div>
            </div>
           ...
           $("#provincias").empty();
            ...
            $.get("/provincias/"+{{ $_notaria->id_region}}+"",function(response,state){
                for(i=0; i< response.length;i++){
                    sel='';
                    if(response[i].provincia_id=={{ $_notaria->id_provincia }}){
            ...
            $.get("/comunas/"+{{ $_notaria->id_provincia }}+"",function(response,state){
                for(i=0; i< response.length;i++){
                    sel='';
                    if(response[i].comuna_id=={{ $_notaria->id_comuna }}){
                        sel=' selected="selected"';
                    }
