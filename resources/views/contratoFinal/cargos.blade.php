    ...
    <div class="col-md-12">
        <div class="white-box">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form action="{{ route('pagospropietario.agregarcargo',$pago->id) }}"  method="post" enctype='multipart/form-data' >
            ...
            <a href="{{ route('finalContrato.edit',[$pago->id_publicacion,0,0,5,'Contrato']) }}" class="btn btn-info" style="color:white"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Volver</a>
        </div>
