                            ...
                            <form id="form1_a" action="{{ route('finalContrato.asignarNotaria',$p->id) }}" method="post">                 
                                ...
                                <td>
                                    ...
                                    @endphp
                                        ...
                                        <a class="mytooltip"href="{{ route('finalContrato.finaliza',[$p->id,$p->id_publicacion]) }}"> <button  class="btn btn-warning btn-circle btn-lg"> <a class="mytooltip" href="{{ route('finalContrato.finaliza',[$p->id,$p->id_publicacion]) }}" style="color:white"><i class="fa fa-lock"></i> <span class="tooltip-content3" style="font-size: medium;color:white">Finalizar / Terminar <br>el Contrato</span></a></button></a>
...
function cargosabonos(obj){
    window.location.href = '/finalContrato/cargosabonos/'+obj.id;
}
