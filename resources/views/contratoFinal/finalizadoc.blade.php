...
<form action="{{ route('finalContrato.savedocsfinaliza',[ $id_contrato, $id_publicacion ]) }}" method="post" enctype='multipart/form-data'>
    {!! csrf_field() !!}
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td  width="10px" height="10px">
                                ...
                                <td width="10px">
                                    <a href="{{ route('finalContrato.eliminardocfinal', [$p->id, $id_contrato, $id_publicacion]) }}" class="btn btn-danger btn-circle btn-lg"><i class="fa fa-check"></i></a>
                                </td>
                                @endcan
                            </tr>
                            @endforeach
