...
<main>
    ...
    <table class="display nowrap" cellspacing="0" width="100%">
        <tr>
            ...
            <td width="80%" style="padding: 15px;">{{ $propietario_propiedad->direccion or null }} # {{ $propietario_propiedad->numero or null}} Dpto {{ $propietario_propiedad->departamento or null}}, {{ $propietario_propiedad->comuna or null}}</td>
        </tr>
        <tr>
            <td width="20%" style="padding: 15px;"><strong>Propietario</strong></td>
            <td width="20%" style="padding: 15px;"> {{ $propietario_propiedad->nombre or null}} {{ $propietario_propiedad->apellido_paterno or null}}, Fono : {{ $propietario_propiedad->telefono or null}}, Email: {{ $propietario_propiedad->email or null}}</td>
        </tr>
    </table>
