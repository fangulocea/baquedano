...
<div id="tabla" class="col-sm-12">
    <div class="white-box">
        <h3 class="box-title m-b-0">Administración de Empresas de Servicios</h3>
        <p class="text-muted m-b-30">Gestionar Empresas</p>
                ...
                <tbody>
                    @foreach($flex as $flexi)
                            <tr>
                                ...
                                <td>{{ trans_choice('mensajes.vigencia', $flexi->id_estado ) }}</td>
                                
                                @can('empresas.edit')
                                <td width="10px">
                                    <a href="{{ route('empresas.edit', $flexi->id) }}"><span class="btn btn-warning btn-circle btn-lg"><i class="ti-pencil-alt"></i></span></a>
                                </td>
                                @endcan
                                @can('empresas.destroy')
                                <td width="10px">

                                    {!! Form::open(['route' => ['empresas.destroy', $flexi->id], 
                                    'method' => 'DELETE']) !!}
