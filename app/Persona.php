...
class Persona extends Model
{
    ...
    protected $fillable=['rut','nombre','apellido_paterno','apellido_materno','direccion','numero','departamento','telefono','email','id_comuna','id_region','id_provincia','tipo_cargo','cargo_id','id_estado'];
