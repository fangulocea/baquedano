...
public function genera_contrato_pro(Request $request){
     ...
     $meses = DB::select(DB::raw('Select 
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -18 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -18 MONTH))) as mesanterior18,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -17 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -17 MONTH))) as mesanterior17,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -16 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -16 MONTH))) as mesanterior16,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -15 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -15 MONTH))) as mesanterior15,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -14 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -14 MONTH))) as mesanterior14,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -13 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -13 MONTH))) as mesanterior13,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -12 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -12 MONTH))) as mesanterior12,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -11 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -11 MONTH))) as mesanterior11,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -10 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -10 MONTH))) as mesanterior10,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -9 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -9 MONTH))) as mesanterior9,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -8 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -8 MONTH))) as mesanterior8,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL -7 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL -7 MONTH))) as mesanterior7,
                    ...
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +7 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +7 MONTH))) as messiguiente7,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +8 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +8 MONTH))) as messiguiente8,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +9 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +9 MONTH))) as messiguiente9,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +10 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +10 MONTH))) as messiguiente10,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +11 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +11 MONTH))) as messiguiente11,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +12 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +12 MONTH))) as messiguiente12,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +13 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +13 MONTH))) as messiguiente13,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +14 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +14 MONTH))) as messiguiente14,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +15 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +15 MONTH))) as messiguiente15,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +16 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +16 MONTH))) as messiguiente16,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +17 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +17 MONTH))) as messiguiente17,
                    CONCAT(MONTH(DATE_ADD(now(), INTERVAL +18 MONTH)),"/",YEAR(DATE_ADD(now(), INTERVAL +18 MONTH))) as messiguiente18'));
        $meses = $meses[0];
