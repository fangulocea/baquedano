...
class CaptacionController extends Controller {
    ...
    public function procesarxls($id) {
        try {
            ...
            foreach ($registros as $r) {
                ...
                $paso="Paso 5 : DIRECCIÓN / NRO / BODEGA / ESTACIONAMIENTO";
            ...
            return back()->with('error', 'No fue posible procesar la información, datos erróneos, se detuvo en el '.$paso);
        }
    }
    ...
    public function store(Request $request) {
        ...
        $request->request->add(['id_creador' => Auth::user()->id]);
