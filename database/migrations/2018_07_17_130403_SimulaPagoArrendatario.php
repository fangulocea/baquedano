...
class SimulaPagoArrendatario extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
       Schema::dropIfExists('cap_simulapagoarrendatarios');
        Schema::create('cap_simulapagoarrendatarios', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->double('precio_en_pesos', 20, 1);
