...
class DetallePagosArrendatarios extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('adm_detallepagosarrendatarios');
        Schema::create('adm_detallepagosarrendatarios', function (Blueprint $table) {
            $table->increments('id');
