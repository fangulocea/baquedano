...
class GenerarPagoArrendatario extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
Schema::dropIfExists('adm_generapagoarrendatario');
        Schema::create('adm_generapagoarrendatario', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->double('gastocomun', 20, 8)->nullable();
